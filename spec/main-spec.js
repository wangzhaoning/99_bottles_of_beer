...
describe('main()',function () {
    ...
    it("2杯数",function () {
        let input=2;
        var result=main(input);
        expect(result).toEqual( "    2 bottles of beer on the wall, 2 bottles of beer.\n" +
    ...
    it("3杯数",function () {
        let input=3;
        var result=main(input);
        expect(result).toEqual("    3 bottles of beer on the wall, 3 bottles of beer.\n" +
    ...
    it("4杯数",function () {
        let input=4;
        var result=main(input);
        expect(result).toEqual("    4 bottles of beer on the wall, 4 bottles of beer.\n" +
